...
const STATUS_CARDS = [
  ...
  { key: "sent_transport",   label: "ส่งจดทะเบียนให้ต้นทางแล้ว",    description: "ส่งจดทะเบียนให้ต้นทางแล้ว",      icon: FileCheck,   bg: "bg-orange-50 hover:bg-orange-100 border-orange-300", iconColor: "text-orange-600", countColor: "text-orange-900" },
